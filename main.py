...
# main.py dosyasının en üst kısımlarına ekle
...
async def proxy_download(url: str, filename: str, media_type: str = "video", quality: str = "720"):
    ...
    if os.path.exists(ffmpeg_path):
        ...
        print(f"✅ HARİKA! Windows FFmpeg Bulundu: {ffmpeg_path}")
    else:
        # Windows'ta değilsek (Railway'deysek) sistemdeki Linux FFmpeg'i kullan
        ydl_opts['ffmpeg_location'] = '/usr/bin/ffmpeg' 
        print("✅ Linux sistem FFmpeg'i kullanılıyor.")
